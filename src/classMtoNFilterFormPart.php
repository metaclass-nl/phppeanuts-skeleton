...
Gen::includeClass('PntMtoNFilterFormPart', 'pnt/web/parts');

/** Kind of FilterFormPart used by MtoNSearchPage 
* to output html describing search forms.
* The part is adapted to the smaller space of the searchFrame.
*
...
*/
class MtoNFilterFormPart extends PntMtoNFilterFormPart {
